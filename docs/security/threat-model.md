...
| Unauthorized job application | Legal/reputation damage | Discovery/drafting only; official link opens for the user; submission capability high-risk and not implemented |
...
job data may be incomplete or malicious; and application submission lacks a
safe adapter. These prevent public-production classification.
